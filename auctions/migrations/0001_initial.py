    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('EL', 'Electronics'), ('CA', 'Clothing and Accessories'), ('HG', 'Home and Garden'), ('VE', 'Vehicles'), ('BM', 'Books and Media'), ('TG', 'Toys and Games'), ('SO', 'Sports and Outdoors'), ('CO', 'Collectibles'), ('SV', 'Services'), ('MI', 'Miscellaneous'), ('NL', 'Not Listed')], default='NL', max_length=2)),
